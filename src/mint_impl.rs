...
where
    T: Copy + fmt::Debug + cmp::PartialOrd,
{
    aabb_min: Option<mint::Point2<T>>,
    aabb_max: Option<mint::Point2<T>>,
}
...
where
    T: Copy + fmt::Debug + cmp::PartialOrd,
{
    aabb_min: Option<mint::Point3<T>>,
    aabb_max: Option<mint::Point3<T>>,
}
    ...
    T: Copy + fmt::Debug + cmp::PartialOrd,
{
    ...
    pub fn update(&mut self, point: &mint::Point2<T>) {
    ...
    T: Copy + fmt::Debug + cmp::PartialOrd,
{
    ...
    pub fn update(&mut self, point: &mint::Point3<T>) {
        if self.aabb_max.is_none() {
            self.aabb_max = Some(*point);
        }
        if self.aabb_min.is_none() {
